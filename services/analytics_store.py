...
def save_user_analytics_stats(
    ...
    item = {
        ...
        "avg_hold_time_minutes":
            Decimal(str(analytics.get("avg_hold_time_minutes", 0))),

        "max_consecutive_losses":
            Decimal(analytics.get("max_consecutive_losses", 0)),

        "best_trading_hour":
            analytics.get("best_trading_hour"),

        "overtrading_signals":
            analytics.get("overtrading_signals", "None"),

        "revenge_trading_count":
            Decimal(analytics.get("revenge_trading_count", 0)),
